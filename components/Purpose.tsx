...
const Purpose = () => {
    ...
    return (
        <div className="flex flex-col gap-10 mb-13 mt-[-10vh] md:mt-0">
            <Copy>
                <h2 data-lag={0.5} className="text-3xl sm:text-4xl md:text-5xl  text-[#aeaeae]">Purpose</h2>
            </Copy>
            <div className="md:text-5xl text-2xl flex flex-col  md:leading-15">
                <Copy>
                    ...
                    <p data-lag={1.1} className="headline2  mb-5">
                    ...
                    <p data-lag={1.3} className="headline2 mb-5">
