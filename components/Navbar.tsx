...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed inset-0 bg-[#efefef] px-5 flex flex-col items-start justify-center gap-8 z-40 transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'
                    }`}
            >
                {[
