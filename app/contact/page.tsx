...
const page = () => {
    return (
        <div className='px-5 md:px-10  bg-[#efefef] font-Outfit dark:bg-[#000000e1] dark:text-[#efeded]'>
            <div className='flex flex-col pt-[10vh] h-screen justify-center pb-[15vh]'>
                <div className='flex flex-col gap-5 mb-20'>
                    <Copy>
                        <p className='text-3xl md:text-5xl text-shadow-text md:leading-[4rem] '>Behind every <span> great design </span> there’s a<br />
